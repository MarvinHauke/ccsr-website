<script lang="ts">
	...
	async function handleSubmit(event: Event) {
		...
		// Simulation der Formular-Übermittlung
...
<svelte:head>
	...
	<meta
		name="description"
		content="Kontaktieren Sie Irregular für professionelle Services rund um elektronische Musikgeräte. Bielefeld, Deutschland."
	/>
</svelte:head>
